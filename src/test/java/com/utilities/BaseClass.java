...
public class BaseClass  {
	...
	public String seleniumWestURI = "@ondemand.us-west-1.saucelabs.com:443";
	public String seleniumEastURI = "@ondemand.us-east-1.saucelabs.com:443";
	...
	protected AppiumDriver<WebElement> createDriver(
			...
			String className,
			String app,
			ConfigFilesUtility configFileObj) throws Exception {
		...
		capabilities.setCapability(MobileCapabilityType.NEW_COMMAND_TIMEOUT, 30 * 10);
		...
		if (configFileObj.getProperty("executionEnvironment").equals("local")) {
			...
			ConfigFilesUtility configObj = new ConfigFilesUtility();
			configObj.loadPropertyFile("ServerDeviceCapabilities.properties");
			username = configObj.getProperty("userName");
			accesskey = configObj.getProperty("accessKey");
			...
			if(!configFileObj.getProperty("executionEnvironment").contains("kobiton")) {
				capabilities.setCapability(AndroidMobileCapabilityType.AUTO_GRANT_PERMISSIONS, true);
				capabilities.setCapability("autoAcceptAlerts", true);
				String executionDevicePlatform = configObj.getProperty("executionPlatform");
				...
				serverURL = "https://" + authentication.getUsername() + ":" + authentication.getAccessKey() + seleniumWestURI + "/wd/hub";
				deviceNameReport = deviceName;
				platformVersionReport = platformVersion;

			} else {
				executionEnvironmentReport = "Kobiton";
				capabilities.setCapability("sessionName", className);
				capabilities.setCapability("captureScreenshots", true);

				capabilities.setCapability("deviceGroup", "KOBITON");
				serverURL = "https://" + username + ":" + accesskey +"@api.kobiton.com/wd/hub";
			}
			...
			if (platformName.equalsIgnoreCase("Android")) {
				...
				driverThread.set(new AndroidDriver(new URL(serverURL), capabilities));
			} else {
				capabilities.setCapability(MobileCapabilityType.AUTOMATION_NAME, AutomationName.IOS_XCUI_TEST);
				driverThread.set(new IOSDriver(new URL(serverURL), capabilities));
			}

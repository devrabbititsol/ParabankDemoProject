...
public class MobileBase {
	...
	protected AppiumDriver<MobileElement> createDriver(
		...
		if(!isSauce) {
			...
			capabilities.setCapability("app", testObjectApiKey);
			username = configFileObj.getProperty("userName");
			accesskey = configFileObj.getProperty("accessKey");
			if(!configFileObj.getProperty("executionPlatform").contains("kobiton")) {
	...
	public void testFail(String message, AppiumDriver<MobileElement> mobileDriver) {
